Objects are dropped into an $80~\text{cm}\times80~\text{cm}\times80~\text{cm}$
...
\begin{figure}[t]
    ...
    \adjincludegraphics[width=0.45\columnwidth,trim={0 {0.05\height} 0
    0},clip]{figures/clutter/clutter_no_walls_t0.png}\\
    \vspace{0.1cm}
...
We evaluate the scalability of SAP by varying the number of objects in the
...
\begin{figure}[!h]
	...
	\adjincludegraphics[height=0.39\columnwidth,trim={{0.05\width} 0
	{0.05\width} 0},clip]{figures/clutter/momentum_error_no_walls.png}\\
