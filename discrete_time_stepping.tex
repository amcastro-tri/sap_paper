...
\emph{gap function} $\phi_i(\mf{q})\in\mathbb{R}$ \RedHighlight{We can say more
...
\cite{bib:tasora2011}, Section 2.3.}. The kinematics of each contact is further
...
\mu_i x_n\}$. \RedHighlight{See \cite{bib:anitescu2006} to probably rewrite this
section in term of constraints and the principle of maximum dissipation.}
...
\begin{flalign}
    ...
    i\in\mathcal{A}(\mf{q}_0,\epsilon) \label{eq:scheme_non_penetration}\\
