...
Our discrete-time model is based on the $\theta\text{-method}$ \RedHighlight{Add
citation to this method} and incorporates the symplectic midpoint rule to attain
