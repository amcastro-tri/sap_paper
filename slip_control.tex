...
incorporate physical compliance. This allows us not only to model compliant point
...
second period and a 75\% duty cycle, left on Fig.~\ref{fig:slip_control_history}. This results in a periodic transition from a
secure grip to a loose grip allowing the spatula to pitch in a controlled manner
within grasp, see Fig.~\ref{fig:slip_control_history} and the accompanying video. We observe that stiction during the
