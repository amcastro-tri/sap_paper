...
surface as a compliant contact point at its centroid.
...
with air filled compliant surfaces (Fig. \ref{fig:slip_control_frame}). The aforementioned gripper is simulated
...
cycle (see Fig.~\ref{fig:slip_control_history}, left). \reviewquestion{R8-Q3}{This
