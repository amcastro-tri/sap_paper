...
the discrete approximation introduced in \RedHighlight{[discrete hydro arxiv]}
to approximate each face of the contact surface as a compliant element at its
centroid.

To demonstrate this capability, we reproduce the test in \RedHighlight{[discrete
hydro arxiv]} that models a \emph{Soft-bubble} gripper
