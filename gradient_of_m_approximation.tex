...
\begin{align*}
	\mf{q}^{\theta_q}(\mf{v}) &= \mf{q}_0 + \delta t \theta_q \dot{\mf{q}}^{\theta_{vq}} \\
	                          &= \mf{q}_0 + \delta t \theta_q \mf{N}(\mf{q}^{\theta_{q}})\mf{v}^{\theta_{vq}}(\mf{v}).
\end{align*}
Hence by the chain rule, $\mf{E}$ can be further calculated as
\begin{align*}
	\mf{E} = \delta t\theta_q\frac{\partial \mf{M}(\mf{q}^{\theta_{q}}) }{\partial\mf{q}}
...
\begin{align*}
		\Vert\mf{E}\Vert 
		&\le \delta t\theta_q \left\| \frac{\partial\mf{M}(\mf{q}^{\theta_{q}})}{\partial\mf{q}}  \right\|
...
$\mf{F}_1(\mf{v})=\mf{F}_1(\mf{q}^{\theta_{q}}(\mf{v}), \mf{v}^{\theta_v}(\mf{v}))$
as
\begin{align*}
	\frac{\partial\mf{F}_1}{\partial \mf{v}} = -\delta t\,\theta_q\theta_{vq}\mf{K}(\mf{q}^{\theta_q},
