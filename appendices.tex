...
\RedHighlight{See where to put these. Super important. For now I'll place them here cause I don't wanna forget.}
...
\end{theorem}
\begin{proof}
	I believe you can simply use the optimality conditions of the primal for a much simpler and cleaner proof. No need to go through cumbersome algebra?\todo{do this.}
\end{proof}
