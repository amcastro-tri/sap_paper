...
velocities when there is no contact. As written, Eq. (\ref{eq:momentum_balance})
assumes an explicit treatment of positions. That is, positions are \emph{frozen}
to their value at the beginning of the step. In Section
\ref{sec:discrete_time_formulation} we show how deal with positions implicitly
and extend our method to support second order integration.
