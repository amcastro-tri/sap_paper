...
\begin{enumerate}
	...
	\item the \emph{maximum dissipation principle}, which states that the friction impulses maximize the rate of energy
...
introduces coupling with the sliding velocity, an artifact of the convex approximation. We provide a detailed discussion on the
