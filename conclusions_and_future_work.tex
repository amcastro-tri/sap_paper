...
\reviewquestion{R1-Q5}{Our formulation does not linearize the friction cone
but it works with the second order cone constraints directly, avoiding spurious
non-physical anisotropy \cite{bib:li2018implicit}. We eliminate constraints
analytically and solve an unconstrained convex problem.
In comparison, an LCP formulation would introduce $(2u+1)$
constraints per contact \cite{bib:anitescu1997}, where $u$ is the number of
edges in the polygonal approximation. This strongly affects the performance of
