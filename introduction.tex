...
\begin{figure}[!ht]
    ...
    Keyframes of a dual arm manipulation task in simulation. The robot is commanded to pick up a jar full of marbles, open it, pour its contents into a bowl, close the lid and place the empty jar back in place. This is a computationally intensive simulation with 160 degrees of freedom and hundreds of contact constraints per time step, see Fig. \ref{fig:dual_arm_contacts}. Our SAP solver is robust and warm-starts effectively, enabling this simulation at interactive rates.}
\end{figure}
%
