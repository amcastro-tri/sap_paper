...
To our knowledge, Chrono \cite{bib:hrono2016}, Mujoco \cite{bib:mujoco} and
...
\reviewquestion{Q8}{Siconos is an open-source software targeting large
...
\reviewquestion{Q9}{It is not even clear if these convex approximations present
a real advantage when compared to approaches solving the original non-convex NCP
problem and whether the artifacts introduced by the approximation are acceptable
