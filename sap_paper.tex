...
\input{discrete_time_stepping.tex}
\input{convex_approximation.tex}
%\input{multibody_dynamics_with_contact.tex} (old)
%\input{mathematical_model.tex} (old)
\input{sap_solver.tex}
\input{modeling_parameters.tex}
%\input{understanding_model_parameters.tex} (old)
