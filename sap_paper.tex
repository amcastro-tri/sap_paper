...
% Introduces \adjincludegraphics to include figures allowing trimming.
...
\input{multibody_dynamics_with_contact.tex}
\input{mathematical_model.tex}
\input{primal_formulation_of_compliant_contact.tex}
\input{unconstrained_convex_formulation.tex}
\input{physical_intuition.tex}
\input{sap_solver.tex}
\input{geodesic_solver.tex}
\input{understanding_model_parameters.tex}
\input{test_cases.tex}
%\input{constraints_modeling_framework.tex}
\input{variations_and_extensions.tex}
\input{conclusions_and_future_work.tex}
%\input{test_cases_old.tex}
