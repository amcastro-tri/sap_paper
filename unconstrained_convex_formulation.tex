...
(second-order accurate) linear approximation in \eqref{eq:momentum_linearized}. It is important to note
however that the approximation can be exact for many multibody systems
...
therefore the approximation is exact.} 
