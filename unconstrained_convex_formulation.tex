...
\reviewquestion{Q8}{We use the analytical $\bgamma =
...
\reviewquestion{Q1/Q2/Q4}{We note that Algorithm
...
while our SPD approximation of the gradient $\partial \mf{m}/\partial \mf{v}$ in
Eq.~\eqref{eq:momentum_linearized} is proven to be second order accurate in
Appendix \ref{app:gradient_of_m_approximation}.}
