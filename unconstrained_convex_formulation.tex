...
\begin{IEEEproof}
    Notice that
    \begin{align*}
        \mf{y}(\mf{v}) &= -\mf{R}^{-1}(\mf{v}_c - \hat{\mf{v}}_c) \\
                       &= \bsigma - (\bsigma + \mf{R}^{-1}(\mf{v}_c - \hat{\mf{v}}_c)) \\
                       &= P_\mathcal{F}(\mf{y}(\mf{v})) - (\bsigma + \mf{R}^{-1}(\mf{v}_c - \hat{\mf{v}}_c)).
    \end{align*}
    By Moreau's decomposition theorem, we have 
    \begin{align*}
        \mf{y}(\mf{v}) &= P_\mathcal{F}(\mf{y(\mf{v})}) + P_{\mathcal{F}^o}(\mf{y}(\mf{v}))
    \end{align*}
    Therefore $-(\bsigma + \mf{R}^{-1}(\mf{v}_c - \hat{\mf{v}}_c)) = P_{\mathcal{F}^o}(\mf{y}(\mf{v})) \in \mathcal{F}^o$.
    Hence $\bsigma + \mf{R}^{-1}(\mf{v}_c - \hat{\mf{v}}_c) \in \mathcal{F}^*$ 
    and so does $\mf{R}\bsigma + \mf{v}_c - \hat{\mf{v}}_c$.
\end{IEEEproof}}
