...
\RedHighlight{TODO: add to Limitations section.}
...
\RedHighlight{TODO: Come up with an easy to explain counter example. Maybe a
stack of objects is the easiest? but one with joints might be more satisfying if
easy to explain.}
...
Note that the $O(d^3)$ per-iteration complexity of SAP is the same
...
We added text at the end of Section IV.D and \RedHighlight{in the Limitations
Section.}

\RedHighlight{TODO: Add text in either conclusions or the "limitations"
section, mentioning that scalability  and other iterative solvers like CG is
future research.}
