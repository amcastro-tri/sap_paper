...
approximation (see Section \ref{sec:two_stage_scheme}). 
...
to thousands of bodies. However, scalability needs to be studied further, along
with the usage of iterative solvers such as conjugate-gradients (CG), widely
