...
%This is in constrast with \emph{simplicial} sparsity algorithms,
%which perform all sparse computation using a list of
%triples $(i, j, H_{ij})$ encoding the non-zero entries  of $H$.
...
%Note this situation
%occurs if all velocities appear in at least one contact constraint,
%and can be enforced in practice by presolving any unconstrained velocities
