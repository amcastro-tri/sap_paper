...
extension of the linear system matrix \cite[\S 6]{bib:vandenberghe2015chordal}.
We study scalability with number of bodies in Section \ref{sec:clutter}. Recent
work on the modeling on contact rich patches \cite{bib:masterjohn2021discrete}
